...
const sendEmailAcceptedMatchRequest = async (info, res, next) => {
    const mailOptions = {
        from: 'unitandem.noreply@gmail.com', // sender address
...
const sendEmailInactiveAccount = async (info, res, next) => {
    const mailOptions = {
        from: 'unitandem.noreply@gmail.com', // sender address
        to: info.userEmail, // list of receivers
        subject: 'Unitandem, new match request!', // Subject line
...
module.exports =
{
    ...
    sendEmailInactiveAccount:sendEmailInactiveAccount
};
